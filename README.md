...
Start up the JSON Server by typing this command into your terminal: 'npm run webservice'. This will run on "https://localhost:1050" . As we have already specified port in package.json file as
"webservice": "json-server --watch db.json --port 1050"
